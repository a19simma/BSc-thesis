...
sns.lineplot(x="time/total_timesteps", y="rollout/ep_rew_mean", data=df_a2c, linewidth=1, color="green", alpha=0.1)
sns.lineplot(x="time/total_timesteps", y="mov_avg", data=df_a2c, label="Learning Rate 0.0001", linewidth=1, color="green")
#sns.lineplot(x="time/total_timesteps", y="rollout/ep_rew_mean", data=df_dqn, linewidth=1, color="purple", alpha=0.1)
#sns.lineplot(x="time/total_timesteps", y="mov_avg", data=df_dqn, label="Learning Rate 0.00001", linewidth=1, color="purple")
