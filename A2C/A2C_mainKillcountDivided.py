...
from vizdoomEnvKillcountDivided import VizDoomTrain
...
LOG_DIR = 'logs/' + SCENARIO + 'KillcountDivided'
TOTAL_TIMESTEPS = 3e6

env = VizDoomTrain(SCENARIO)
env = Monitor(env)
model = A2C('CnnPolicy', env, tensorboard_log=LOG_DIR, verbose=0, learning_rate=0.00001, n_steps=2048)
